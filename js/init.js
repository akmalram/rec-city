...
function arlo_tm_animate_text() {
    ...
    animateSpan.typed({
        strings: [
            "<span class=\"color-primary\">«Rec city»</span> - город, который никогда не спит",
            "<span class=\"color-primary\">«Rec city»</span> - город, в котором твой голос будет услышан",
            "<span class=\"color-primary\">«Rec city»</span> - город, саундтреком к которому станет твоя музыка",
            "ЗДЕСЬ, ЧТОБЫ ПРЕВРАТИТЬ ТВОЮ ПЕСНЮ В ХИТ"
        ],
        loop: true,
        startDelay: 1e3,
        backDelay: 4e3
